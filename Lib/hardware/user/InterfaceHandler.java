...
public class InterfaceHandler {
	...
	public static void powerOnOff() {
		...
		System.out.print("Power " + (ui.getBtnHandler().getPowerState() ? "on...\n" : "off...\n"));
...
//			System.out.println("Connected IFH");
...
//				if (isGUI) {
//
//					ui.getUserInterface().getprinterTextArea().setText("No race!\n");
//					ui.getUserInterface().getjTextArea1().append("No race!\n");
//					Printer.printToPrinter("No race!\n");
//
//				} else {
...
//
//				if (isGUI) {
//					ui.getUserInterface().getprinterTextArea().setText("Run <" + run + ">\n");
//
...
//										if (isGUI) {
//
////											ui.getUserInterface().getjTextArea1()
////													.append(String.format("<%05d> ", groupID).toString() + "<"
////															+ ClockInterface.getTotalTimeFormatted(
////																	tempRacer.getStartInLong(),
////																	tempRacer.getFinishInLong())
////															+ ">\n");
//											
//											ui.getUserInterface().getprinterTextArea().setText(
//													ui.getUserInterface().getprinterTextArea().getText() + String.format("<%05d> ", groupID).toString() + "<"
//															+ ClockInterface.getTotalTimeFormatted(
//																	tempRacer.getStartInLong(),
//																	tempRacer.getFinishInLong())
//															+ ">\n");
...
//											System.out.println("<" + ClockInterface.getTotalTimeFormatted(
...
//
////											ui.getUserInterface().getjTextArea1()
////													.append(String.format("<%05d>  <DNF>\n", groupID).toString());
//											
//											ui.getUserInterface().getprinterTextArea().setText(
//													ui.getUserInterface().getprinterTextArea().getText() + String.format("<%05d>  <DNF>\n", groupID).toString() + '\n');
//
//										} else {
//
...
//									if (isGUI) {
//
////										ui.getUserInterface().getjTextArea1().append((!tempRacer.isDNF()
////												? ("<" + tempRacer.getBib() + ">" + " " + "<"
////														+ ClockInterface.getTotalTimeFormatted(
////																tempRacer.getStartInLong(), tempRacer.getFinishInLong())
////														+ ">\n")
...
//										
//										ui.getUserInterface().getprinterTextArea().setText(
//												ui.getUserInterface().getprinterTextArea().getText() + 
//												(!tempRacer.isDNF()
//														? ("<" + tempRacer.getBib() + ">" + " " + "<"
//																+ ClockInterface.getTotalTimeFormatted(
//																		tempRacer.getStartInLong(), tempRacer.getFinishInLong())
...
//									} else {
//
//										System.out.println(!tempRacer.isDNF()
//												? "<" + (tempRacer.getBib() + ">" + " " + "<"
//														+ ClockInterface.getTotalTimeFormatted(
//																tempRacer.getStartInLong(), tempRacer.getFinishInLong())
//														+ ">")
...
//				if (isGUI) {
//					
////					ui.getUserInterface().getjTextArea1().append("No such run!\n");
//					
////					ui.getUserInterface().getprinterTextArea().setText("No such run!\n");
//					P
//				} else {
...
//						if (isGUI) {
//							ui.getUserInterface().getTxtAConsole().append("New run created!\n");
//						} else {
...
//						if (isGUI) {
//							ui.getUserInterface().getTxtAConsole()
//									.append("Run is active please stop the last run before starting a new one!\n");
//						} else {
...
//					if (isGUI) {
//						ui.getUserInterface().getTxtAConsole().append("Run ended\n");
//					} else {
...
//					}
				...
				case "CANCEL": // Redo!
					...
					// System.out.println("Before cancel: " + ui.getRaceManager().racersPoolSize());
					//
					// if(ui.getRaceManager().getChannelSelected() == 1 ||
					// ui.getRaceManager().getChannelSelected() == 2){
					// ui.getRaceManager().getRaces()[0].CANCEL();
					// }
					// else if(ui.getRaceManager().getChannelSelected() == 3 ||
					// ui.getRaceManager().getChannelSelected() == 4) {
				...
				case "SWAP":
					if (ui.getRaceManager().swap()) {
						if (isGUI) {
							...
							// TODO correctly update middle txt Area
...
//						System.out.println("Disconected IFH");
